...
**Returns a dynamically allocated array of all stored data in the list.**

**Parameters:**
- `head` — Pointer to the head of the list

**Returns:** Pointer to the array of data, or NULL if allocation fails
...
**Compute the Beta function using the incomplete Beta function;**
